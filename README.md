...
|F| [Table Flipping](https://www.facebook.com/codingcompetitions/hacker-cup/2021/final-round/problems/F)| [*PyPy](./Final%20Round/table_flipping.py) | _O(N * (logN)^2)_ | _O(NlogN)_| Hard | | Line Sweep, 2D Segment Tree, Implicit Segment Tree, Graph, DFS |
