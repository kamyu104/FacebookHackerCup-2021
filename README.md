...
|C2| [Valet Parking - Chapter 2](https://www.facebook.com/codingcompetitions/hacker-cup/2021/round-2/problems/C2)| [PyPy](./Round%202/valet_parking_chapter_2.py) [PyPy](./Round%202/valet_parking_chapter_2-5.py)<br>[PyPy](./Round%202/valet_parking_chapter_2-2.py) [PyPy](./Round%202/valet_parking_chapter_2-6.py)<br>[Python](./Round%202/valet_parking_chapter_2-3.py) [PyPy](./Round%202/valet_parking_chapter_2-7.py)<br>[Python](./Round%202/valet_parking_chapter_2-4.py) [Python](./Round%202/valet_parking_chapter_2-8.py) | _O((R * C + S) * logR)_ | _O(R * C)_ | Hard | | Array, BIT, Fenwick Tree, Skip List, Sorted List, Heap, Segment Tree |
