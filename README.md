...
|B| [Chainblock](https://www.facebook.com/codingcompetitions/hacker-cup/2021/round-2/problems/B)| [Python](./Round%202/chainblock.py) [Python](./Round%202/chainblock.py) | _O(N)_ | _O(N)_ | Medium | | Tree Traversal, LCA, Tarjan's Offline LCA Algorithm, Union Find |
...
|D| [String Concatenation](https://www.facebook.com/codingcompetitions/hacker-cup/2021/round-1/problems/D)| [PyPy](./Round%202/string_concatenation.py) [Python](./Round%202/string_concatenation2.py) | _O(N + N1*(logN1)^2 + N2^3/6 + 2^X*(N3-X)/C)_ | _O(N)_ | Hard | | Array, Pigeonhole Principle, BIT, Fenwick Tree, Bitmask |