...
|C2| [Valet Parking - Chapter 2](https://www.facebook.com/codingcompetitions/hacker-cup/2021/round-2/problems/C2)| [PyPy](./Round%202/valet_parking_chapter_2.py) [PyPy](./Round%202/valet_parking_chapter_2-2.py) [PyPy](./Round%202/valet_parking_chapter_2-3.py) | _O((R * C + S) * logR)_ | _O(R * C)_ | Hard | | Array, BIT, Fenwick Tree, Sorted List, Heap, Segment Tree |
