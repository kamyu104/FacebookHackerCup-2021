...
|F| [Table Flipping](https://www.facebook.com/codingcompetitions/hacker-cup/2021/final-round/problems/F)| [*PyPy](./Final%20Round/table_flipping.py) [PyPy](./Final%20Round/table_flipping2.py) | _O(NlogN)_ | _O(NlogN)_| Hard | | 2D Line Sweep, 2D Segment Tree, Implicit Segment Tree, Graph, DFS, BFS |
