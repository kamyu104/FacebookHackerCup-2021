...
|E| [Antisocial](https://www.facebook.com/codingcompetitions/hacker-cup/2021/final-round/problems/E)| [*PyPy](./Final%20Round/antisocial.py) [C++](./Final%20Round/antisocial.cpp) [Voronoi](./Final%20Round/voronoi.py)  | _O(NlogN)_ | _O(N)_ | Hard | | Geometry, Voronoi Diagram, Fortune's Algorithm, Maximum Spanning Tree, Graph, Kruskal's Algorithm |
